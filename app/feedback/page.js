...
const Feedback = () => {
  ...
  return (
    <>
      ...
      <div>
        <button type="button" className=" items-center text-center flex mx-auto bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded"><a className='text-white' href="mailto:sareekraft25@gmail.com" target="_blank">Send Us Your Reviewes</a></button>
