    ...
    return (
        <>
            <main className='m-5'>
                ...
                <h1 className="text-3xl text-center text-purple-950 font-bold">Connect With Us</h1>
                <div>
                    <div className="text-2xl text-purple-950 font-bold pb-2">
                        <h3>Our Contact Info</h3>


                    </div>
                    <div className="mb-4">
                        <p className='mb-2'>Email:<a className='text-black' href="mailto:sareekraft25@gmail.com" target="_blank"> sareekraft25@gmail.com</a></p>
                        <p>Ph.No : <a href="tel:+918080674236" target="_blank">8080674236</a></p>


                    </div>

                </div>
                  <div className="bg-purple-900 h-1 opacity-20">
      </div>

                
                <div>
                    <h3 className='text-2xl text-purple-950 font-bold pb-2 mt-3'>Follow Us On</h3>

                    <div>
                        <p className='font-bold mb-3'>  
                            ("Click on the Icon To Visit Our
                            Pages")
                        </p>
                    </div>
                    ...
                    <div className="Socialmedia">
                        Youtube Channel : &nbsp;
                        <a href="https://www.youtube.com/@Sareekraft" target="_blank">
                            <svg
                                width="64px"
                                height="64px"
                    ...
                    <div className="Socialmedia">
                        Instagram Handel : &nbsp;
                        <a href="https://www.instagram.com/sareekraft/?igsh=cnprZzJsbGlqdnlz#" target="_blank">
                            <svg
                                width={64}
                                height={64}
                            ...
                            >
                                <defs>
                                    <radialGradient id="insta-grad-a" cx="217.76" cy="3290.99" r="4271.92" gradientUnits="userSpaceOnUse">
                                        <stop offset=".09" stopColor="#fa8f21" />
                                        <stop offset=".78" stopColor="#d82d7e" />
                                    </radialGradient>
                                    <radialGradient id="insta-grad-b" cx="2330.61" cy="3182.95" r="3759.33" gradientUnits="userSpaceOnUse">
                    ...
                    <div className="Socialmedia">
                        Our Facebook Handel : &nbsp;
                        <a href="https://www.facebook.com/people/Saree-Kraft/61572297316146/?rdid=Fu8ZbV6vOpvqEzvA&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1Fp3xvzRCy%2F"
                            target="_blank">
                            <svg
                                width="64px"
                                height="64px"
